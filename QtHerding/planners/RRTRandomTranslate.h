...
class RRTRandomTranslate : public ompl::geometric::RRT
{
public:

  RRTRandomTranslate(const ompl::base::SpaceInformationPtr &si);
  virtual ~RRTRandomTranslate();
  ...
  void setConfigRegistrator(std::function<void(ompl::base::State*, ompl::base::State*)> reg);
...
protected:
  ...
  std::function<void(ompl::base::State*, ompl::base::State*)> reg_;
	int eps_samples;
